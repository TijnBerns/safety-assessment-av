""" 
Module containing sampling functionality of normalizing flows.
"""
...
def sample(
    dataset: str, version: str, num_normal: int, num_event: int
    ...
    normal = sample_normal(
        flow_module, num_normal, save=dataset.root / "normal_sampled.npy"
    )

    # Generate event train data
    print(f"Generating {num_event} event train data")
    event = sample_event(
        flow_module, num_event, threshold, xi, save=dataset.root / "event_sampled.npy"
    )
    ...
    test = sample_normal(
        flow_module, num_samples=num_test, save=dataset.root / "test_sampled.npy"
    )
