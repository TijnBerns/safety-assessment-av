...
def main(checkpoint: str):
    ...
    flow_module = FlowModule.load_from_checkpoint(checkpoint).eval()
    ...
    print(f'log likelihood normal {flow_module.compute_log_prob(normal_data)}')
    print(f'log likelihood event {flow_module.compute_log_prob(event_data)}')
    print(f'log likelihood normal only {flow_module.compute_log_prob(normal_data_only)}')
    print(f'log likelihood event only {flow_module.compute_log_prob(event_data_only)}')
