...
def _plot(axs, df, label, tp: str):
    ...
    axs.plot(
        df["x"],
        df[f"improved_{tp}".lower()] / df[f"baseline_{tp}".lower()],
        label=label,
    )
    axs.legend()
...
def exp1():
    ...
    files = [
        Path(
            "estimates/kde_naive_ensemble/gaussian/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.1.results.csv"
        ),
        Path(
            "estimates/kde_naive_ensemble/gaussian/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.5.results.csv"
        ),
        Path(
            "estimates/kde_naive_ensemble/gaussian/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.9.results.csv"
        ),
    ]
...
def main():
    ...
    exp4(
        Path(
            "estimates/naive_ensemble/t/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.5.results.csv"
        )
    )
    exp4(
        Path(
            "estimates/naive_ensemble/beta/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.5.results.csv"
        )
    )
    exp4(
        Path(
            "estimates/naive_ensemble/gumbel/results/p_edge_0.08.n_normal_1000.n_edge_1000.corr_0.5.results.csv"
        )
    )
